...
import {
  InterestedBuildersPanel,
  TeamRosterPanel,
} from "@/components/participants/team-headquarters-panels";
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <InterestedBuildersPanel
            interestedUsers={selectedTeamInterestedUsers}
            onRespondToInterestedUser={onRespondToInterestedUser}
          />
          <TeamRosterPanel
            members={displayMemberProfiles}
            memberCount={displayMembers}
