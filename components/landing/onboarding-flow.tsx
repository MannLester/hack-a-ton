...
const githubProfileUrlPrefix = "https://github.com/";
const githubProfileHostPrefix = "github.com/";
const linkedinProfileUrlPrefix = "https://linkedin.com/in/";
const linkedinProfileHostPrefix = "linkedin.com/in/";
...
function stripProfileUrlShell(value: string) {
  return value
    .trim()
    .replace(/^https?:\/\//i, "")
    .replace(/^www\./i, "");
...
function getProfileUsername(value: string, hostPrefix: string) {
  return stripProfileUrlShell(value)
    .replace(hostPrefix, "")
    .replace(/^@/, "")
    .replace(/^\/+/, "");
}

function getProfileUrl(username: string, urlPrefix: string) {
...
export function OnboardingFlow() {
  ...
  function handleGithubUsernameChange(username: string) {
    const profileUsername = getProfileUsername(username, githubProfileHostPrefix);

    setGithubUrl(getProfileUrl(profileUsername, githubProfileUrlPrefix));
  }

  function handleLinkedinUsernameChange(username: string) {
    const profileUsername = getProfileUsername(username, linkedinProfileHostPrefix);

    setLinkedinUrl(getProfileUrl(profileUsername, linkedinProfileUrlPrefix));
  }
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex h-11 overflow-hidden rounded-md border-2 border-zinc-200 bg-white focus-within:border-[#00a7e8]">
                    <span className="flex items-center gap-2 border-r-2 border-zinc-100 bg-zinc-50 px-3 text-sm font-black text-zinc-400">
                      <svg
                        className="size-4"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <input
                      value={getProfileUsername(githubUrl, githubProfileHostPrefix)}
                ...
                <div>
                  ...
                  <div className="flex h-11 overflow-hidden rounded-md border-2 border-zinc-200 bg-white focus-within:border-[#00a7e8]">
                    ...
                    <input
                      value={getProfileUsername(linkedinUrl, linkedinProfileHostPrefix)}
                      onChange={(e) => handleLinkedinUsernameChange(e.target.value)}
                      placeholder="yourname"
                      className="min-w-0 flex-1 px-3 text-sm font-bold outline-none"
                    />
                  </div>
